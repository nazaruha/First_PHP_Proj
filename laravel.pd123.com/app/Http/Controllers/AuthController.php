...
class AuthController extends Controller
{
    public function __construct() {
        $this->middleware('auth:api', ['except' => ['login', 'register']]); // доступ лише для авторизованих юзерів ОКРІ логіна і регістра
    }
    ...
    public function register(Request $request) {
        ...
        $user = User::create(array_merge(
            $validator->validated(),
            ['password' => bcrypt($request->password), 'image'=> $filename] // bcrypt шифрує пароль
        ));
